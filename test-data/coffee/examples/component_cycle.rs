...
#[component(
    ...
    heater1: scoped_bind(ElectricHeater) [logger, heater2],
    heater2: scoped_bind(ElectricHeater) [logger, heater1],
    pump: scoped_bind(ThermoSiphon<ElectricHeater>) [logger, heater1],
    maker: static_bind(CoffeeMaker<ElectricHeater, ThermoSiphon<ElectricHeater>>) [logger, heater2, pump]
)]
